...
import org.gradoop.model.impl.algorithms.fsm.baseline.IterativeNaiveTransactionalFSMiner;
 ...
 * @param <E> edge type
 */
public class BaselineIterativeTransactionalFSM
   ...
   */
  public BaselineIterativeTransactionalFSM(FSMConfig fsmConfig) {
    super(fsmConfig, new IterativeNaiveTransactionalFSMiner());
  }
