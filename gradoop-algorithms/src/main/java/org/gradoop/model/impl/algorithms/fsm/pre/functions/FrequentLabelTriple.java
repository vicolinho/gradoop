...
public class FrequentLabelTriple
  extends RichFilterFunction<LabelTripleWithSupport> {

  /**
   * name of broadcast data set for minimum support
   */
  private static final String DS_NAME = "minSupport";
  /**
   * minimum support
   */
  ...
  @Override
  public boolean filter(LabelTripleWithSupport tripleWithSupport
  ) throws Exception {
