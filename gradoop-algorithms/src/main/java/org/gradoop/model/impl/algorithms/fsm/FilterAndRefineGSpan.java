...
//    DataSet<ArrayList<FatEdge>> prunedAdjacencyLists =
//      getPrunedEdges(collection);
//
...
//   * @return search space
//   */
//  private DataSet<ArrayList<FatEdge>> getPrunedEdges(
...
//
//    DataSet<ArrayList<FatEdge>> graphEdges = edges
//      .groupBy(0)
//      .reduceGroup(new GraphFatEdges());
//
//    return graphEdges;
//  }
//
