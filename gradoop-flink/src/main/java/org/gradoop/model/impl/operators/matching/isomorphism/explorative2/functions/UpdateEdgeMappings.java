...
public class UpdateEdgeMappings extends
  RichFlatJoinFunction<EmbeddingWithTiePoint, TripleWithDirection, EmbeddingWithTiePoint> {
  /**
  ...
  @Override
  public void join(EmbeddingWithTiePoint embedding, TripleWithDirection edgeStep,
    ...
    if (edgeEmbeddings[candidate] == null) {
      ...
      embedding.setTiePointId(edgeStep.getTargetId());
